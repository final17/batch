        ...
        return new Tasklet() {
            ...
            public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) throws Exception {
                ...
                for (SettlementSummaryDto ssd : settlementSummaryDtos) {
                    SettlementSummary settlementSummary = new SettlementSummary(LocalDate.parse(ssd.getSummaryDate()), ssd.getType() , ssd.getTotalAmount() , ssd.getTotalFee() , ssd.getTotalTransactions());
